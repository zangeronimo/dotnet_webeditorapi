...
public class UserController : ControllerBase
{
    ...
    private readonly IUseCase<GetUserProfileRequest, UserProfileDto> _getUserProfileUC;
    ...
    public UserController(
        ...
        IUseCase<GetUserProfileRequest, UserProfileDto> getUserProfileUC,
    ...
    public async Task<IActionResult> GetUserProfile()
    {
        ...
        var companyId = (Guid)HttpContext.Items["CompanyId"]!;
        var context = new RequestContext(userId, companyId);
        var request = new GetUserProfileRequest(context);
        var user = await _getUserProfileUC.ExecuteAsync(request);
