...
public class LegacyCategoryMapping : IEntityTypeConfiguration<LegacyCategory>
{
    public void Configure(EntityTypeBuilder<LegacyCategory> builder)
    {
        ...
        builder.Property(c => c.LevelId).HasColumnName("recipe_levels_id");
