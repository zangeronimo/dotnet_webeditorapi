...
public class ApiClientMapping : EntityMapping<ApiClient>
{
    public override void Configure(EntityTypeBuilder<ApiClient> builder)
    {
        ...
        builder.Property(u => u.ClientId).HasColumnName("client_id").HasMaxLength(100).IsRequired();
        builder.Property(u => u.EncryptedSecret).HasColumnName("encrypted_secret").HasMaxLength(500).IsRequired();
